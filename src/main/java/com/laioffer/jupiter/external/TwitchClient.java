...
import com.laioffer.jupiter.CredentialsNoGitHubSync;
...
public class TwitchClient {
    private static final String TOKEN = CredentialsNoGitHubSync.TOKEN;
    private static final String CLIENT_ID = CredentialsNoGitHubSync.CLIENT_ID;
